...
![Assessors](/images/guides/assessors.png)

## 1. Add Assessors
- Allows to add assessors to the specific grant.
- Clicking on the "Add Assessor" icon opens a new page where we can add assessors.

![Add Assessors](/images/guides/add-assessor.png)

**Email Address**: Allows to add an email address, which we want to add as an assessor.
