...
This is a dyanmic report that allows to view reports based on selected data preferences. The report is customizable and in the below case, the report is showing applications **id** and **name**.
