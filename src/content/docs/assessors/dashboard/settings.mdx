...
![Organizational Settings](/images/guides/org-settings.png)

### i. Invite Users
    - The icon next to the **Users** title allows users to invite new users to join the organization.

    ![Invite Users](/images/guides/invite-user.png)
    - Upon clicking, will open a modal that requires users to enter the :
        ...
        - **Grant :** A dropdown to associate the user with a specific grant.
...
### ii. User List
    ...
    - The user list is structured into distinct sections based on roles and associated grants
        ...
        - **Grant Specific User Group**:
            ...
            - The **Grant Specific User Group** is displays following details in the table:
