...
# April 2025 - ✨ Introducing the Application Sharing Feature!

## New Features
-  Introduced a new application sharing feature to enhance collaboration.

## Enhancements
-  Improved smart insights functionality with the ability to use attachments for insights generation.
-  Added temporal capabilities for dynamic prompting and insights.
-  Enabled user-configurable settings for smart insights.
-  Made various UI improvements for better user experience, including enhanced visibility for warnings and the addition of client logos.
-  Improved the layout and functionality of forms, including better formatting for monetary values.
...
-  Corrected errors related to application submissions, including issues with attachments.
-  Resolved various bugs impacting user interactions and data handling.
