...
-  After filling in the required fields and clicking Next, users are directed to the Templates selection screen. Here they can: 
    ...
    - **Start from scratch**: Use the **Start from scratch** option to build a new form without a template.
...
- After selecting a template, users are navigated to the Form Builder, where they can customize the template as needed. The key sections include:
    ...
    - **Template Description**: A collapsible section where users can add or modify the description of the template. Users can review and modify the template title while viewing the template type.
...
- After making modifications to the form, users can Save or Save & Proceed to finalize their changes and move to the next step. 