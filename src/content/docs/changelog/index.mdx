...
# April 2025 – ✨ Introducing the Application Sharing Feature & Smarter Filtering!

## New Features

- Introduced a new **Application Sharing** feature to enhance collaboration.
- Upgraded **Advanced Filtering** with the ability to save and share filters across your organization.
- Added **Smart Insights** enhancements including the ability to generate insights directly from attachments.

## Enhancements

- Improved **Smart Insights** functionality with:
  - Ability to generate insights from attachments.
  - User-configurable settings for insights categories.
  - Easier management of insight categories directly in the interface.
- Enhanced **Advanced Filtering**:
  - Faster, more precise filtering experience.
  - Save filters for reuse without needing to recreate them.
  - Share saved filters across teams for better collaboration.
  - Cleaner, simpler filter interface.
- Made various UI improvements for a better user experience:
  - Enhanced visibility for warnings.
  - Added client logos in key areas.
  - Smarter sidebar and navigation behavior.
  - Improved editor usability with a clickable writing area and better variable handling.
- Improved the layout and functionality of forms:
  - Fixed issues with attachment handling.
  - Better formatting for monetary values.
- Enhanced API functionalities to support additional features and endpoints.

## Bug Fixes

- Resolved visibility issues for new assessors in the system.
- Fixed CSS issues in modals and templates.
- Addressed notification delivery problems to ensure timely alerts.
- Corrected errors related to application submissions, including attachment handling.
- Resolved pagination, quick action, and filtering bugs for smoother user interactions.
- Fixed data fetching errors to ensure reliable record retrieval.
- Improved stability and reliability across backend processes.

## General Improvements

- Enhanced the overall user interface for better navigation and usability.
- Improved documentation and support resources for users.
- More consistent styling and layout polish across the platform.
- Added warnings for unsupported browsers to improve user guidance.
