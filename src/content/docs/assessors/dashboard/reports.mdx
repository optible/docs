...
The Reports section provides an overview of **Application Statuses or Stages**, **Budget Distribution**, **Assessment Results** as well as **Dynamic Reports**. By default, this section displays reports for all grants. We can filter by a specific grant as well using the **Filter grants..** dropdown at the top right.
...
![Assessment Results](/images/guides/reports/assessment.png)
...
- As by default, this shows the accepted and rejection rates for all applications of grants within an organization. And after filtering, it would show the accepted and rejection rates for applications of a specific grant.
...
This is a dynamic report that allows to view reports based on selected data preferences. The report is customizable and in the below case, the report is showing how many of the applications which are **eligible** and **ineligible** by regions.
