...
The Reports section provides an overview of **Application Statuses or Stages**, **Budget Distribbution**, **Assessment Results** as well as **Dynamic Reports**. By default, this section displays reports across all stages for all grants. We can filter by a specific grant using the **Filter grants..** dropdown at the top right.
...
- This section presents a visual summary of assessment results using donut charts, helping users quickly understand the approval and rejection rates of applications.
...
- insights into why applications are being rejected.
